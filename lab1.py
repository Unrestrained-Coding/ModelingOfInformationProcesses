...
def main():
    ...
    with open("res_lab1.txt", "w+") as file:
        file.write("bi\t" + str(np.round(bi,2)))
        file.write("\n")
        file.write("ci\t" + str(np.round(ci,2)))
        file.write("\n")
        file.write("sorted_indexes\t" +str(_sorted_indexes))
        file.write("\n")
        file.write("sorted_ci\t" +str(np.round([ci[index - 1] for index in _sorted_indexes],2)))
        file.write("\n")
        file.write("sorted_bi\t" +str(np.round([bi[index - 1] for index in _sorted_indexes],2)))
        file.write("\n")
        file.write("lambda\t" +str(np.round(_lambda,2)))
        file.write("\n")
        file.write("b\t" +str(np.round(B1,2)))
        file.write("\n")
        file.write("S\t" +str(np.round(S,2)))
        file.write("\n")
